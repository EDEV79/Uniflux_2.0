...
$saasAdminCssPath = defined('APP_PUBLIC_ROOT') ? APP_PUBLIC_ROOT . '/assets/css/saas-admin.css' : '';
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset_url('assets/css/saas-admin.css')); ?>?v=<?php echo e($saasAdminCssVersion); ?>">
</head>
