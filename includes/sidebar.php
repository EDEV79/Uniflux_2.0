...
$navigationItems = array(
    ...
    array('key' => 'gastos', 'label' => 'Gastos', 'icon' => 'fa-solid fa-wallet', 'href' => 'modules/gastos/index.php', 'capability' => 'gastos.manage'),
    array('key' => 'solicitudes', 'label' => 'Solicitudes', 'icon' => 'fa-solid fa-list-check', 'href' => 'solicitudes.php', 'capability' => 'solicitudes.manage'),
    array('key' => 'clientes', 'label' => 'Clientes Admin', 'icon' => 'fa-solid fa-users-gear', 'href' => 'modules/clientes/index.php', 'capability' => 'clientes.manage'),
    array('key' => 'servicios', 'label' => 'Servicios', 'icon' => 'fa-solid fa-briefcase', 'href' => 'modules/servicios/index.php', 'capability' => 'servicios.view'),
);
?>
