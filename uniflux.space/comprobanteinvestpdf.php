...
require APP_ROOT . '/fpdf/fpdf.php';
include APP_ROOT . '/connection/conexion.php';
include APP_ROOT . '/connection/funciones.php';

define('LOGO_PATH', __DIR__ . '/assets/logo.png');
define('LOGO_FALLBACK_PATH', __DIR__ . '/assets/img/transnegralogonew.png');
define('QR_TEMP_DIR', APP_ROOT . '/storage/tmp/qr');
