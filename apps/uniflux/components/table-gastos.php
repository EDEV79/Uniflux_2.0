            ...
            <thead>
                <tr>
                    <?php foreach ($sortableColumns as $columnKey => $columnLabel) : ?>
                        ...
                        ?>
                        <th>
                            <a class="table-sort <?php echo $isActive ? 'is-active' : ''; ?>" href="<?php echo e(app_url('gastos.php')); ?>?<?php echo e(query_string_with(array('sort' => $columnKey, 'dir' => $nextDirection, 'page' => 1))); ?>">
                        ...
                        <tr data-filter-row>
                            ...
                            <td data-label="Acciones">
                                <div class="d-flex justify-content-end gap-1 table-actions">
                                    <a class="tbl-action tbl-action--edit" href="<?php echo e(app_url('gastos.php')); ?>?action=edit&id=<?php echo e($record['idgastos']); ?>" title="Editar" aria-label="Editar gasto <?php echo e($record['idgastos']); ?>">
        ...
        <nav aria-label="Paginacion de gastos">
            <ul class="pagination mb-0">
                <li class="page-item <?php echo $pagination['current_page'] <= 1 ? 'disabled' : ''; ?>">
                    <a class="page-link" href="<?php echo e(app_url('gastos.php')); ?>?<?php echo e(query_string_with(array('page' => max(1, $pagination['current_page'] - 1)))); ?>">Anterior</a>
                </li>
                <?php for ($pageNumber = 1; $pageNumber <= $pagination['total_pages']; $pageNumber++) : ?>
                    <li class="page-item <?php echo $pageNumber === $pagination['current_page'] ? 'active' : ''; ?>">
                        <a class="page-link" href="<?php echo e(app_url('gastos.php')); ?>?<?php echo e(query_string_with(array('page' => $pageNumber))); ?>"><?php echo e($pageNumber); ?></a>
                    </li>
                <?php endfor; ?>
                <li class="page-item <?php echo $pagination['current_page'] >= $pagination['total_pages'] ? 'disabled' : ''; ?>">
                    <a class="page-link" href="<?php echo e(app_url('gastos.php')); ?>?<?php echo e(query_string_with(array('page' => min($pagination['total_pages'], $pagination['current_page'] + 1)))); ?>">Siguiente</a>
                </li>
            </ul>
        </nav>
    </div>
